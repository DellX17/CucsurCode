...
<section class="video-form">
   ...
   <h1 class="heading">Actualizar materia</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Actualizar nombre <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="Nombre" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>Actualizar cuerpo de la lección <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Descripción" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>Cambiar la materia</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--Selecciona una materia</option>
         <?php
      ...
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">Ver lección</a>
         <input type="submit" value="Borrar lección" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">No se encontro la lección! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">agrega una nueva</a></p>';
      }
   ?>
