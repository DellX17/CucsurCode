...
<section class="view-content">
   ...
   <div class="container">
      ...
      if ($vidSOURCE!="") {
      ?>
      <video src="../uploaded_files/<?= $vidSOURCE; ?>" autoplay controls poster="../uploaded_files/<?= $fetch_content['thumb']; ?>" class="video"></video>
      <?php
      }
      ?>
      ...
      <p style="white-space: pre-line;";><?= $fetch_content['description']; ?></div></p>   
      
      <form action="" method="post">
         <div class="flex-btn">
            <input type="hidden" name="video_id" value="<?= $video_id; ?>">
            <a href="update_content.php?get_id=<?= $video_id; ?>" class="option-btn">Actualizar</a>
            <input type="submit" value="BORRAR" class="delete-btn" onclick="return confirm('Realmente quieres borrar?');" name="delete_video">
         </div>
      </form>
      <a href="quiz.php?get_id=<?= $video_id; ?>" class="btn"> Ejercicios</a>
   </div>
   <?php
    }
   }else{
      echo '<p class="empty">No hay lecciones <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Agrega nuevas</a></p>';
   }
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Confirmar');">Borrar comentario </button>
         </form>
      </div>
      <?php
       }
