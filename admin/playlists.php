...
<section class="playlists">
   ...
   <div class="box-container">
      ...
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Crear una nueva materia</h3>
         <a href="add_playlist.php" class="btn">Nueva materia</a>
      </div>
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Borrar" class="delete-btn" onclick="return confirm('Confirmar borrar materia');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">Ver más</a>
      </div>
      <?php
         } 
      }else{
         echo '<p class="empty">No tienes ninguna materia aún!</p>';
      }
      ?>
