...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Nombre de la materia <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="Como podran buscar esta materia" value="<?= $fetch_playlist['title']; ?>" class="box">
      <p>Descripción <span>*</span></p>
      <textarea name="description" class="box" required placeholder="De que se trata esta materia" maxlength="1000" cols="30" rows="10"><?= $fetch_playlist['description']; ?></textarea>
      ...
      <div class="flex-btn">
         ...
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Ver materia</a>
      </div>
   </form>
   <?php
      } 
   }else{
      echo '<p class="empty">No se encontro la materia!</p>';
   }
   ?>
