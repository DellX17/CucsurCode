...
if(isset($_POST['submit'])){
   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         $message[] = 'la contraseña vieja no es correcta';
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
            ...
            <input type="password" name="old_pass" placeholder="introduzca su vieja contraseña" maxlength="20"  class="box">
            <p>Nueva contraseña :</p>
            <input type="password" name="new_pass" placeholder="introduzca una nueva contraseña" maxlength="20"  class="box">
            <p>Confirmar contraseña :</p>
            <input type="password" name="cpass" placeholder="confirme su nueva contraseña" maxlength="20"  class="box">
         </div>
      </div>
      <p>Actualizar foto :</p>
